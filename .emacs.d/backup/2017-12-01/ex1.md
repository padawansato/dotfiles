...
```
~/Desktop/コンパイラ構成論 $ clang -S -O0 ex1.c
ex1.c:1:2: error: invalid preprocessing directive
#extern int printf(char *,...);
 ^
ex1.c:10:1: warning: implicitly declaring library function
      'printf' with type 'int (const char *, ...)'
      [-Wimplicit-function-declaration]
printf("%x = %x + %x \n",f(a,b),a,b);
^
ex1.c:10:1: note: include the header <stdio.h> or explicitly
      provide a declaration for 'printf'
1 warning and 1 error generated.
~/Desktop/コンパイラ構成論 $ clang -S -O ex1.c
ex1.c:1:2: error: invalid preprocessing directive
#extern int printf(char *,...);
 ^
ex1.c:10:1: warning: implicitly declaring library function
